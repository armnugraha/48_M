...
import {Container,Left,Content,Body,Header,Right, Title, Subtitle,Toast} from "native-base";
...
export default class Home extends Component {
    constructor(props) {
        ...
        this.state = {isLoading: true,isSearch:false,textSearch:"",titleListGunung: "Sudah Pernah Kesini ?",nameCity:"Bandung",tempCity:"0",randomSearch:"",
            dataFilterObjects: [
                {
    ...
    handleBackPress = () => {return BackHandler.exitApp()};
    ...
    fetchData(){
        ...
        Api.get('/mounts/?page=1').then(resp =>{
                ...
                <Content refreshControl={
                    ...
                    <View style={styles.contentHeader}>
                        ...
                        <View style={styles.pageHeader2}>
                            <Text style={styles.titleTextSearch}>Mau Naik Kemana?</Text>
                    ...
                    :
                        <FlatList
                            ...
                            renderItem = {({item, index}) => ( <ListItemData {...item} /> )}
